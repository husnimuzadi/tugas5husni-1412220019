...
<div class="container mt-5">
    <div class="card border border-primary">
        ...
        <div class="card-body">
            <form action="<?php echo isset($barang) ? site_url('barang/edit_barang/' . $barang['ID_Barang']) : site_url('barang/tambah_barang'); ?>" method="post">
                <div class="row">
                    <div class="col-md-6">
                ...
                <div class="form-group">
                    <button type="submit" class="btn btn-primary btn-block mt-3"><?php echo isset($barang) ? 'Ubah' : 'Simpan'; ?></button>
